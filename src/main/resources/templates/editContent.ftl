...
<div class="g-doc">
    ...
    <div class="n-public">
        <form class="m-form m-form-ht" id="form" method="post" action="/editSubmit/${content.id!}" onsubmit="return false;"
              autocomplete="off">
            <div class="fmitem">
                <label class="fmlab">标题：</label>
                <div class="fmipt">
                    <input class="u-ipt ipt" name="title" value="${content.title}" autofocus="" placeholder="2-80字符">
                </div>
            </div>
            <div class="fmitem">
            ...
            <div class="fmitem">
                ...
                <div class="fmipt" id="urlUpload">
                    <input class="u-ipt ipt" name="image" value="${content.image}" placeholder="图片地址">
                </div>
            ...
            <div class="fmitem">
                ...
                <div class="fmipt">
                    <input class="u-ipt price" name="num" value="${content.num?c}">件
                </div>
            </div>
